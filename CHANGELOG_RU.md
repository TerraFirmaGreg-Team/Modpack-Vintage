...
- Добавлены следующие рецепты (и их соответствующее использование): (Спасибо MDetonados)
  - Сборщик: Цепь (23) + любой Словарь руды Зерно = Ванильная пшеница — используется для исследования Таумономикона;
  - Сборщик: Цепь (23) + любой 8 рудный словарь Булыжник = Ванильная печь — используется для рецепта Плавильни эссенции;
  ...
  - Сборщик: Цепь (23) + любой Грунт Словаря Руды = Ванильная Грязь — используется для исследования Таумономикона;
