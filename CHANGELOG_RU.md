...
## [4.3.6] - 2023-08-18
### Исправления модпака
- Понижена версия GC для исправления зависания.
- Исправлено отстсвия зависимостей

## [4.3.5] - 2023-08-18
### Исправления модпака
- Исправление появление пылек на поверхности
### Новые моды
...
## [4.3.4] - 2023-08-17
### Исправления модпака
- Исправление разных версий модов на расширенной версии
### Обновление модов
- HammerLib
...
## [4.3.3] - 2023-08-17
### Исправления модпака
- Понижена версия CustomSkinLoader
- Уален мод visualores, на старых мирах занимает слишком много времени для кеширования.
### Обновление модов
- CustomSkinLoader
### Удаленные моды
- visualores
...
## [4.2.8] - 2023-03-25
### Исправления модпака
- Добавлен мод PreventGhost который предотвращает(но полностью) создание призрачных блоков. При рассинхронизации.
- Исправлен рецепт Yeast.
### Обновление модов
- AppliedEnergistics2
- HadEnoughItems
- Bogosorter
...
## [4.2.7] - 2023-03-21
### Исправления модпака
- Отключены high tier машины, которые по ошибке попали в модпак.
...
- Исправлена ошибка рецепта палок, когда пила исчезала при использовании.
- В mmc пакет, по умолчанию добавлены аргументы java для оптимизации.
- Исправлена работа геологического молотка.
- Исправлены рецепты крафта короны.
- Исправлена ошибка при использовании инструменов гт, когда они просто исчезали после одного крафта.
- Исправлен крафт вулканических агентов.
- Изменен квест в примитивной эре на латекс.
### Обновление модов
- TFG-mod
- CraftPresence
- Groovyscript
...
- Название ресурспака теперь будет одно, чтоб при обновлении не переключать его каждый раз при обнолвении.
...
## [3.0.0] - 13.01.2022
- GTCE заменен на GTCEu, из-за того, что старая версия перестала обновляться по не понятным причинам, новая же версия содержит в себе миллионы исправлений и оптимизаций, все это вы можете посмотреть по [ссылке](https://github.com/Gregicality/GregTech "нажми"), в файле ChangeLog-GTCEU
