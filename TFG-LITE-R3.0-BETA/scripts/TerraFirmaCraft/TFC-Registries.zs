...
ItemRegistry.registerItemMetal(<ore:dustImpureEnargite>.firstItem, "COPPER", 15, true);
//Энаргит --- Большая Кучка
ItemRegistry.registerItemMetal(<ore:dustEnargite>.firstItem, "COPPER", 35, true);
...
ItemRegistry.registerItemMetal(<ore:dustRegularIron>.firstItem, "WROUGHT_IRON", 100, false);
...
// --- Вариации Цинка
//Цинк --- Грязная Кучка
ItemRegistry.registerItemMetal(<ore:dustImpureZinc>.firstItem, "ZINC", 80, true);
//Цинк --- Средняя Кучка
