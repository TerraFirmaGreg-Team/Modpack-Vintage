...
Anvil.addRecipe("firmalife/greenhouse_wall", <metaitem:plateWroughtIron>, <tfg:device/greenhouse/wall> * 4, 3, "general", "HIT_NOT_LAST", "PUNCH_NOT_LAST", "SHRINK_LAST");

// Бафф крафта крыши теплицы
Anvil.addRecipe("firmalife/greenhouse_roof", <metaitem:plateWroughtIron>, <tfg:device/greenhouse/roof> * 4, 3, "general", "HIT_THIRD_LAST", "PUNCH_SECOND_LAST", "PUNCH_LAST");
