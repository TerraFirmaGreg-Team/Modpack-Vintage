...
recipes.remove(<extraplanets:tier1_space_suit_jetpack_chest>);
recipes.remove(<extraplanets:tier1_space_suit_legings>);
recipes.remove(<extraplanets:tier1_space_suit_boots>);
recipes.remove(<extraplanets:tier1_space_suit_gravity_boots>);
//2
recipes.remove(<extraplanets:tier2_space_suit_helmet>);
recipes.remove(<extraplanets:tier2_space_suit_chest>);
recipes.remove(<extraplanets:tier2_space_suit_jetpack_chest>);
recipes.remove(<extraplanets:tier2_space_suit_legings>);
recipes.remove(<extraplanets:tier2_space_suit_boots>);
recipes.remove(<extraplanets:tier2_space_suit_gravity_boots>);
//3
recipes.remove(<extraplanets:tier2_space_suit_helmet>);
recipes.remove(<extraplanets:tier2_space_suit_chest>);
recipes.remove(<extraplanets:tier2_space_suit_jetpack_chest>);
...
*/
//Кислородный компрессор 2
recipes.remove(<extraplanets:advanced_oxygen_compressor>);
/*
...
*/
//Кислородный компрессор 3
recipes.remove(<extraplanets:ultimate_oxygen_compressor>);
/*
...
*/
//Кислородный декомпрессор 2
recipes.remove(<extraplanets:advanced_oxygen_compressor:4>);
/*
...
[[<gregtech:meta_item_1:12072>, <ore:circuitAdvanced>, <gregtech:meta_item_1:12072>],
 ...
 [<gregtech:meta_item_1:12072>, <gregtech:machine:503>, <gregtech:meta_item_1:12072>]]);
*/
//Кислородный декомпрессор 3
recipes.remove(<extraplanets:ultimate_oxygen_compressor:4>);
/*
...
recipes.addShaped(<galacticraftcore:parachute>,
[[<tfc:animal/product/wool_cloth>, <tfc:animal/product/wool_cloth>, <tfc:animal/product/wool_cloth>],
...
recipes.addShaped(<galacticraftcore:flag>,
[[<gregtech:meta_item_1:14184>, <tfc:animal/product/wool_cloth>, <tfc:animal/product/wool_cloth>],
 [<gregtech:meta_item_1:14184>, <tfc:animal/product/wool_cloth>, <tfc:animal/product/wool_cloth>],
 [<gregtech:meta_item_1:14184>, null, null]]);
//тепло шлем
...
[[<galacticraftplanets:item_basic_asteroids:7>, <minecraft:leather_helmet>, <galacticraftplanets:item_basic_asteroids:7>],
 ...
 [null, null, null]]);
//тепло нагрудник
recipes.remove(<galacticraftplanets:thermal_padding:1>);
...
//тепло поножи
recipes.remove(<galacticraftplanets:thermal_padding:2>);
...
//тепло ботинки
recipes.remove(<galacticraftplanets:thermal_padding:3>);
...
//тепло шлем 3
recipes.remove(<extraplanets:tier3_thermal_padding>);
...
//тепло шлем 4
recipes.remove(<extraplanets:tier4_thermal_padding>);
...
//тепло шлем 5
recipes.remove(<extraplanets:tier5_thermal_padding>);
...
[[<ore:dustRedstone>, <ore:platePlatinum>, <ore:dustRedstone>],
 ...
 [<ore:dustRedstone>, <ore:platePlatinum>, <ore:dustRedstone>]]);
//Радиоизотопное ядро
recipes.remove(<galacticraftplanets:basic_item_venus:2>);
...
recipes.remove(<galacticraftcore:emergency_box:1>);
/*
recipes.addShaped(<galacticraftcore:emergency_box:1>,
[[<galacticraftcore:emergency_box>, <galacticraftcore:emergency_kit>, null],
 [<ore:circuitBasic>, null, null],
 [null, null, null]]);
*/
//Самоспасатель
recipes.remove(<galacticraftcore:emergency_kit>);
/*
recipes.addShaped(<galacticraftcore:emergency_kit>,
[[<tfc:metal/pick/steel>, <galacticraftcore:oxygen_mask>, <galacticraftcore:oxygen_gear>],
 [<galacticraftcore:oxygen_tank_light_full>, <galacticraftcore:parachute:*>, <galacticraftcore:oxygen_tank_light_full>],
 [<galacticraftcore:food>, <minecraft:potion>.withTag({Potion: "minecraft:healing"}), <minecraft:potion>.withTag({Potion: "minecraft:night_vision"})]]);
*/
//Взлетная площадка 1лвл
...
//Взлетка 2лвл
recipes.remove(<extraplanets:advanced_launch_pad>*5);
...
//Взлетка 3лвл
recipes.remove(<extraplanets:advanced_launch_pad:1>*5);
...
recipes.remove(<extraplanets:advanced_launch_pad:2>);
...
//Счетчик гейгера
recipes.remove(<extraplanets:geiger_counter>);
...
recipes.remove(<extraplanets:gravity_controller>);
...
recipes.remove(<extraplanets:module_items:1>);
...
[[null, <ore:leather>, null],
 ...
 [null, <ore:leather>, null]]);
//Колесо 2-уго уровня
recipes.remove(<extraplanets:electric_parts:2>);
...
[[null, <galacticraftplanets:item_basic_mars:3>, null],
 ...
 [null, <galacticraftplanets:item_basic_mars:3>, null]]);
//Колесо 3-го уровня
recipes.remove(<extraplanets:electric_parts:3>);
