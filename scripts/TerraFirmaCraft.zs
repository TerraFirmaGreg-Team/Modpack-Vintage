...
mixer.recipeBuilder().inputs(<gregtech:meta_item_1:2018>*9, <gregtech:meta_item_1:2071>).outputs(<gregtech:meta_item_1:2095>*10).duration(200).EUt(8).buildAndRegister();
mixer.recipeBuilder().inputs(<gregtech:meta_item_1:1018>*9, <gregtech:meta_item_1:1071>).outputs(<gregtech:meta_item_1:2095>*10).duration(200).EUt(8).buildAndRegister();	
large_mixer.recipeBuilder().inputs(<gregtech:meta_item_1:2018>*9, <gregtech:meta_item_1:2071>, <gregtech:meta_item_1:32766>.withTag({Configuration: 2})).outputs(<gregtech:meta_item_1:2095>*10).duration(200).EUt(8).buildAndRegister();
large_mixer.recipeBuilder().inputs(<gregtech:meta_item_1:1018>*9, <gregtech:meta_item_1:1071>, <gregtech:meta_item_1:32766>.withTag({Configuration: 2})).outputs(<gregtech:meta_item_1:2095>*10).duration(200).EUt(8).buildAndRegister();	
