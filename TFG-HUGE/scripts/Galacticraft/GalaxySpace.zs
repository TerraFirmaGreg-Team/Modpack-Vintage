...
// Деко блоки
recipes.addShapeless("tfg/galaxyspace/decor_block_1", <galaxyspace:decoblocks>, [<galacticraftcore:basic_block_core:3>, <ore:plateCobalt>]);
recipes.addShapeless("tfg/galaxyspace/decor_block_2", <galaxyspace:decoblocks:1>, [<galacticraftcore:basic_block_core:3>, <ore:plateMagnesium>]);
recipes.addShapeless("tfg/galaxyspace/decor_block_3", <galaxyspace:decoblocks:2>, [<galacticraftcore:basic_block_core:3>, <ore:plateNickel>]);
recipes.addShapeless("tfg/galaxyspace/decor_block_4", <galaxyspace:decoblocks:3>, [<galacticraftcore:basic_block_core:3>, <ore:plateCopper>]);

// Схематика пустая
recipes.addShapeless("tfg/galaxyspace/schematic_empty", <galaxyspace:gs_basic:14>, [<ore:paper>, <ore:paper>, <projectred-fabrication:ic_blueprint>]);
...
// Solar Flare Module
recipes.addShaped("tfg/galaxyspace/solar_flare_module", <galaxyspace:gs_basic:1>,
...
recipes.addShaped("tfg/galaxyspace/solar_panel_hybride", <galaxyspace:modern_solarpanel>,
...
recipes.addShaped("tfg/galaxyspace/modification_table", <galaxyspace:modification_table>,
...
recipes.addShaped("tfg/galaxyspace/panel_controller", <galaxyspace:panel_controller>,
...
recipes.addShaped("tfg/galaxyspace/radiation_stabiliser", <galaxyspace:radiation_stabiliser>,
...
// Солнечный парус
recipes.addShaped("tfg/galaxyspace/solar_wind_panel", <galaxyspace:solarwind_panel>,
...
// Планитарный щит
recipes.addShaped("tfg/galaxyspace/planet_shield", <galaxyspace:planet_shield>,
...
// Ветряная мельница
recipes.addShaped("tfg/galaxyspace/wind_generator", <galaxyspace:wind_generator>,
...
// Клетка для животных
recipes.addShaped("tfg/galaxyspace/case_for_animals", <galaxyspace:gs_basic:32>,
   [[<ore:plateBlackSteel>, <ore:plateBlackSteel>, <ore:plateBlackSteel>],
   [<galacticraftcore:grating>, <ore:carpet>, <ore:plateBlackSteel>],
   [<ore:plateBlackSteel>, <ore:plateBlackSteel>, <ore:plateBlackSteel>]]);

// Тир 1 лэндер
recipes.addShaped("tfg/galaxyspace/rocket_modules", <galaxyspace:rocket_modules>,
...
// Антирад
recipes.addShaped("tfg/galaxyspace/anti_radiation", <galaxyspace:gs_basic:9> * 3,
...
// Тир 3 лэндер
recipes.addShaped("tfg/galaxyspace/lander_tier_3", <galaxyspace:rocket_modules:2>,
...
// Blank Module
recipes.addShaped("tfg/galaxyspace/blank_module", <galaxyspace:gs_basic:11>,
...
recipes.addShaped("tfg/galaxyspace/module_stabilization", <galaxyspace:upgrades:1>,
...
// Module Speed
recipes.addShaped("tfg/galaxyspace/module_speed", <galaxyspace:upgrades:2>,
   [[null, <galaxyspace:gs_basic:3>, null],
   [<ore:wireGtSingleManganesePhosphide>, <galaxyspace:gs_basic:11>, <ore:wireGtSingleManganesePhosphide>],
   [<ore:plateNickel>, <metaitem:wafer.glowstone>, <ore:plateNickel>]]);

// Module Expander
recipes.addShaped("tfg/galaxyspace/module_expander", <galaxyspace:upgrades>,
   [[null, <galaxyspace:gs_basic:12>, null],
   [<ore:wireGtSingleManganesePhosphide>, <galaxyspace:gs_basic:11>, <ore:wireGtSingleManganesePhosphide>],
   [<ore:plateCobalt>, <metaitem:wafer.glowstone>, <ore:plateCobalt>]]);

// Module Energy
recipes.addShaped("tfg/galaxyspace/module_energy", <galaxyspace:upgrades:3>,
