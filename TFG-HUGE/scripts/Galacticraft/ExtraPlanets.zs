...
assembler.recipeBuilder()
   ...
   .fluidInputs([<liquid:soldering_alloy> * 288])
   .outputs(<contenttweaker:rocketparts_tier4>)
   .duration(600)
   .EUt(830)
   .buildAndRegister();
// Tier 5
assembler.recipeBuilder()
   ...
   .inputs(<galacticraftcore:spin_thruster> * 2)
	.inputs(<galaxyspace:rocket_modules:3> * 4)
   .fluidInputs([<liquid:soldering_alloy> * 288])
   .outputs(<contenttweaker:rocketparts_tier5>)
   .duration(600)
   .EUt(930)
   .buildAndRegister();
// Tier 6
assembler.recipeBuilder()
   ...
   .inputs(<galacticraftcore:spin_thruster> * 2)
	.inputs(<galaxyspace:rocket_modules:3> * 4)
   .fluidInputs([<liquid:soldering_alloy> * 288])
   .outputs(<contenttweaker:rocketparts_tier6>)
   .duration(600)
   .EUt(1030)
   .buildAndRegister();
// Tier 7
...
assembly_line.recipeBuilder()
   ...
   .inputs(<contenttweaker:rocketparts_tier4> * 16)
...
assembly_line.recipeBuilder()
   ...
   .inputs(<contenttweaker:rocketparts_tier5> * 16)
...
assembly_line.recipeBuilder()
   ...
   .inputs(<contenttweaker:rocketparts_tier6> * 16)
