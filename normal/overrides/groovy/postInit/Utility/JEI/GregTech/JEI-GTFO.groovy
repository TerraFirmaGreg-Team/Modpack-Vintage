...
// for (name in removeRecipesByName) {
//    crafting.remove(name);
// }

// // Удаление рецептов печи
// furnace.removeByInput(metaitem('brick.adobe'));



// // Удаление рецептов метана
// mods.gregtech.centrifuge.removeByInput(5, [metaitem('crop.onion')], null)
// mods.gregtech.centrifuge.removeByInput(5, [metaitem('food.grapes')], null)
...
// // GT Mud Bricks
// mods.gregtech.forming_press.removeByInput(30, [item('tfc:sand/phyllite') * 3, item('tfc:gravel/granite') * 2, metaitem('dustBentonite'), metaitem('dustTalc'), item('minecraft:wheat'), metaitem('wooden_form.brick')], null)
...
// mods.gregtech.extractor.removeByInput(1920, [item('minecraft:apple')], null)
...
// // Kebab Meat Raw
// mods.gregtech.cuisine_assembler.removeByInput(16, [item('minecraft:rabbit') * 4, metaitem('dustTinySalt') * 4, metaitem('component.skewer') * 4], null)
// mods.gregtech.cuisine_assembler.removeByInput(16, [item('minecraft:chicken') * 4, metaitem('dustTinySalt') * 4, metaitem('component.skewer') * 4], null)
// mods.gregtech.cuisine_assembler.removeByInput(16, [item('minecraft:mutton') * 4, metaitem('dustTinySalt') * 4, metaitem('component.skewer') * 4], null)
// mods.gregtech.cuisine_assembler.removeByInput(16, [item('minecraft:porkchop') * 4, metaitem('dustTinySalt') * 4, metaitem('component.skewer') * 4], null)
// mods.gregtech.cuisine_assembler.removeByInput(16, [item('minecraft:beef') * 4, metaitem('dustTinySalt') * 4, metaitem('component.skewer') * 4], null)

// // Mince Meat
// mods.gregtech.large_chemical_reactor.removeByInput(256, [item('minecraft:rabbit') * 32], [fluid('methanol') * 4000, fluid('chloroform') * 4000])
// mods.gregtech.large_chemical_reactor.removeByInput(256, [item('minecraft:chicken') * 32], [fluid('methanol') * 4000, fluid('chloroform') * 4000])
// mods.gregtech.large_chemical_reactor.removeByInput(256, [item('minecraft:beef') * 32], [fluid('methanol') * 4000, fluid('chloroform') * 4000])
// mods.gregtech.large_chemical_reactor.removeByInput(256, [item('minecraft:mutton') * 32], [fluid('methanol') * 4000, fluid('chloroform') * 4000])
// mods.gregtech.large_chemical_reactor.removeByInput(256, [item('minecraft:porkchop') * 32], [fluid('methanol') * 4000, fluid('chloroform') * 4000])

// // // Mince Meat + BoneMeal + Animal Fat
// // centrifuge.findRecipe(20, [<minecraft:rabbit:0> * 8, <metaitem:circuit.integrated>.withTag({Configuration: 2})], null).remove();
// // centrifuge.findRecipe(20, [<minecraft:porkchop:0> * 8], null).remove();
// // centrifuge.findRecipe(20, [<minecraft:beef:0> * 8], null).remove();
// // centrifuge.findRecipe(20, [<minecraft:mutton:0> * 8], null).remove();
// // centrifuge.findRecipe(20, [<minecraft:chicken:0> * 8], null).remove();
...
// // Greenhouse
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 2), metaitem('circuit.integrated').withNbt([Configuration: 2])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 2), metaitem('circuit.integrated').withNbt([Configuration: 1])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 2), metaitem('fertilizer') * 2, metaitem('circuit.integrated').withNbt([Configuration: 4])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 2), metaitem('circuit.integrated').withNbt([Configuration: 3])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 4), metaitem('circuit.integrated').withNbt([Configuration: 2])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 4), metaitem('circuit.integrated').withNbt([Configuration: 1])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 4), metaitem('fertilizer') * 2, metaitem('circuit.integrated').withNbt([Configuration: 4])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 4), metaitem('circuit.integrated').withNbt([Configuration: 3])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 6), metaitem('circuit.integrated').withNbt([Configuration: 2])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 6), metaitem('circuit.integrated').withNbt([Configuration: 1])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 6), metaitem('fertilizer') * 2, metaitem('circuit.integrated').withNbt([Configuration: 4])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 6), metaitem('circuit.integrated').withNbt([Configuration: 3])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 8), metaitem('circuit.integrated').withNbt([Configuration: 2])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 8), metaitem('circuit.integrated').withNbt([Configuration: 1])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 8), metaitem('fertilizer') * 2, metaitem('circuit.integrated').withNbt([Configuration: 4])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 8), metaitem('circuit.integrated').withNbt([Configuration: 3])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 10), metaitem('circuit.integrated').withNbt([Configuration: 2])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 10), metaitem('circuit.integrated').withNbt([Configuration: 1])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 10), metaitem('fertilizer') * 2, metaitem('circuit.integrated').withNbt([Configuration: 4])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 10), metaitem('circuit.integrated').withNbt([Configuration: 3])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 12), metaitem('circuit.integrated').withNbt([Configuration: 2])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 12), metaitem('circuit.integrated').withNbt([Configuration: 1])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 12), metaitem('fertilizer') * 2, metaitem('circuit.integrated').withNbt([Configuration: 4])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 12), metaitem('circuit.integrated').withNbt([Configuration: 3])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 14), metaitem('circuit.integrated').withNbt([Configuration: 2])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0', 14), metaitem('circuit.integrated').withNbt([Configuration: 1])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(90, [item('gregtechfoodoption:gtfo_sapling_0', 14), metaitem('toolHeadChainsawSteel'), metaitem('circuit.integrated').withNbt([Configuration: 5])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(90, [item('gregtechfoodoption:gtfo_sapling_0', 14), metaitem('fertilizer'), metaitem('toolHeadChainsawSteel'), metaitem('circuit.integrated').withNbt([Configuration: 6])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0'), metaitem('circuit.integrated').withNbt([Configuration: 2])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0'), metaitem('circuit.integrated').withNbt([Configuration: 1])], [fluid('water') * 10000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0'), metaitem('fertilizer') * 2, metaitem('circuit.integrated').withNbt([Configuration: 4])], [fluid('water') * 20000])
// mods.gregtech.greenhouse.removeByInput(60, [item('gregtechfoodoption:gtfo_sapling_0'), metaitem('circuit.integrated').withNbt([Configuration: 3])], [fluid('water') * 20000])
