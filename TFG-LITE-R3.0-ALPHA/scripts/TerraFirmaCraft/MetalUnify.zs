...
Welding.addRecipe("tfc:TFG_gear_bismuth", <ore:rackwheelBismuth>, <ore:sleeveTin>, <ore:gearBismuth>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_bismuth_bronze", <ore:rackwheelBismuthBronze>, <ore:sleeveTin>, <ore:gearBismuthBronze>.firstItem, 2);
Welding.addRecipe("tfc:TFG_gear_black_bronze", <ore:rackwheelBlackBronze>, <ore:sleeveTin>, <ore:gearBlackBronze>.firstItem, 2);
Welding.addRecipe("tfc:TFG_gear_brass", <ore:rackwheelBrass>, <ore:sleeveTin>, <ore:gearBrass>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_bronze", <ore:rackwheelBronze>, <ore:sleeveTin>, <ore:gearBronze>.firstItem, 2);
Welding.addRecipe("tfc:TFG_gear_copper", <ore:rackwheelCopper>, <ore:sleeveTin>, <ore:gearCopper>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_gold", <ore:rackwheelGold>, <ore:sleeveTin>, <ore:gearGold>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_lead", <ore:rackwheelLead>, <ore:sleeveTin>, <ore:gearLead>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_nickel", <ore:rackwheelNickel>, <ore:plateNickel>, <ore:gearNickel>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_rose_gold", <ore:rackwheelRoseGold>, <ore:sleeveTin>, <ore:gearRoseGold>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_silver", <ore:rackwheelSilver>, <ore:sleeveTin>, <ore:gearSilver>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_tin", <ore:rackwheelTin>, <ore:sleeveTin>, <ore:gearTin>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_zinc", <ore:rackwheelZinc>, <ore:sleeveTin>, <ore:gearZinc>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_sterling_silver", <ore:rackwheelSterlingSilver>, <ore:sleeveTin>, <ore:gearSterlingSilver>.firstItem, 1);
Welding.addRecipe("tfc:TFG_gear_wrought_iron", <ore:rackwheelWroughtIron>, <ore:sleeveBrass>, <ore:gearWroughtIron>.firstItem, 3);
Welding.addRecipe("tfc:TFG_gear_pig_iron", <ore:rackwheelPigIron>, <ore:sleeveBrass>, <ore:gearPigIron>.firstItem, 3);
Welding.addRecipe("tfc:TFG_gear_steel", <ore:rackwheelSteel>, <ore:sleeveBrass>, <ore:gearSteel>.firstItem, 4);
Welding.addRecipe("tfc:TFG_gear_platinum", <ore:rackwheelPlatinum>, <ore:sleeveSteel>, <ore:gearPlatinum>.firstItem, 5);
Welding.addRecipe("tfc:TFG_gear_black_steel", <ore:rackwheeBlackSteel>, <ore:sleeveSteel>, <ore:gearBlackSteel>.firstItem, 5);
Welding.addRecipe("tfc:TFG_gear_blue_steel", <ore:rackwheelBlueSteel>, <ore:sleeveSteel>, <ore:gearBlueSteel>.firstItem, 6);
Welding.addRecipe("tfc:TFG_gear_red_steel", <ore:rackwheelRedSteel>, <ore:sleeveSteel>, <ore:gearRedSteel>.firstItem, 6);
