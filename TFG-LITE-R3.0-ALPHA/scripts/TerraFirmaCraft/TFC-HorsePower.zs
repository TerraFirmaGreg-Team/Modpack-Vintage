...
//-
Grindstone.add(<gregtech:ore_zinc_0>, <ore:dustImpureZinc>.firstItem * 3, 10, false);
...
Grindstone.add(<gregtech:ore_kaolinite_0>, <ore:dustImpureKaolinite>.firstItem * 3, 10, false);
