...
Anvil.removeRecipe(<cellars:bronze_ice_saw>);
Anvil.removeRecipe(<cellars:bismuth_bronze_ice_saw>);
Anvil.removeRecipe(<cellars:black_bronze_ice_saw>);
Anvil.removeRecipe(<cellars:wrought_iron_ice_saw>);
Anvil.removeRecipe(<cellars:steel_ice_saw>);
Anvil.removeRecipe(<cellars:black_steel_ice_saw>);
Anvil.removeRecipe(<cellars:red_steel_ice_saw>);
Anvil.removeRecipe(<cellars:blue_steel_ice_saw>);