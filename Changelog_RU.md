...
## Version R4.0.0 - Ожидается 25.07.2022
#### [Lite, Huge]
### Исправления модпака
...
* Добавлен русский перевод для кассомных материалов.
* Исправлен перевод дублирующего названия кованного железа, на Оксид железа (III).
* Включена оптимизация облаков.
* Включена интеграйция OC с Appliedenergistics2 и GalacticCraft.
* Удалена ядерная бомба, из ExtraPlanets.
* Был удален GalaxySpace в пользу ExtraPlanets, сменилась плаента Phobos, если у вас там что то было, лучше перенести перед обнолвением.
* На немного увеличена скорость роста растений.
* Проведена оптимизация конфигов мода Weather2.
* Сменено оформление ToolTips и подсказки TheOneProbe.
* Добавлен цвет пылькам, которые получаются из камней других планет.
* Изменена текстура холода и тепла, мода TFCAmbiental.
* Устранен краш на сервере Magma, с модом FastWorkbench.
* С мобов теперь падают монетки GT, котороые можно обменять в валюту(/convert) для покупки вкусняшек в игровом магазине.
...
* Добавлены квесты, для ознокомления с модом TFCMedicinal.
...
### Новые моды
* REID - Мод увеличивающий лимит id блоков майнкрафт, сделан намного чище и имеет поддержку от разработчиков, что позволит в будущем использовать его с другими модами, исправит странную генерацию и странные краши связанные с отсутствием каких-то классов в игре, также увеличит фпс и снизит нагрузку на ЦП. **ЭТОТ МОД в 95% СЛУЧАЕВ УНИЧТОЖИТ ВАШИ СТАРЫЕ МИРЫ. ЕСЛИ ВЫ ХОТИТЕ ПРОДОЛЖИТЬ ИГРАТЬ В СТАРЫХ МИРАХ УДАЛИТЕ ЭТОТ МОД И УСТАНОВИТЕ ОБРАТНО** [NEID](https://www.curseforge.com/minecraft/mc-mods/notenoughids?page=2).
* AE2Additions - мод, тот же что и ExtraCells2, но с множеством исправлений и оптимизаций, перед обновлением лучше разобрать или удалить предменты из мода, это качается высокоуровневых ячеек и некоторых терминалов.
* TFCMedicinal
