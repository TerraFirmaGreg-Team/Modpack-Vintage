...
* Исравлен рецепт контролера лифта, а так же удаленной панели управления лифтом.
* Изменены рецепты ExtraCPUs.
* Исправлены рецепты крафтов Crafting Storage, тепрь они все делаются в упаковщике.
* Отключен эффект невесомости HotorNot, при взятии в руку емкостей с газами.
* Исправлен баг, когда не возможно было попасть через врата на другую планету, все еще на дороботке, так же включено автозакрытие через 900 сек, при отсутсвии игрока, это можно пресечь, если использвать beamer и что нибудь транспортировать сквозь червоточину.
* Отлючено затачивание для GT предметов.
