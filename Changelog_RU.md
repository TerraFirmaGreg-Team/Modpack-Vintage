...
* В заприваченых териториях, по умолчанию включены взрывы, чтоб машинки GT взрывались, а так же думаю надо позаботится об освещении своей базы.
* Скорреутированы возможности littletiles
...
* Удален дублирующии рецепты из Lapis, Diamond, Emerald.
...
* Удаление ордикта у ванильного дерева.
...
* В дерево материалов добалены AE2 заряженый и флакс кристылы, и так же жидкости к ним, они так же используются в рецептах.
### Обновление модов
