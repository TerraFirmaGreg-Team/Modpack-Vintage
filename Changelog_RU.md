...
* Был удален GalaxySpace в пользу ExtraPlanets, сменилась планета Phobos, если у вас там что то было, лучше перенести перед обнолвением.
...
* AE2Additions - мод, тот же что и ExtraCells2, но с множеством исправлений и оптимизаций, перед обновлением лучше разобрать или удалить предменты из мода, это касается высокоуровневых ячеек и некоторых терминалов.
* TFCMedicinal
