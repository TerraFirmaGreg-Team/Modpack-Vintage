...
## Version R4.1.1 - ожидается 30.08.2022
#### [Normal, Huge]
### Исправления модпака
...
* Добавлены рецепты скафандров, прочной ткани, защитных/антирадиоционных/атмосферных пластин ExtraPlanets.
* Переписаны рецепты Xtones.
* Полностью переписаны рецепты 1-3 тира ракет, теперь в рецепте участвую новые предметы, компьюерный контролер ракеты, разделеный по тирам ракет.
