...
## Version R4.0.1 - Ожидается 31.07.2022
#### [Normal, Huge]
### Исправления модпака
...
* Добавлены растения пригодные для изготовления лекарств, в том числе тепрь из водрослей и каралов тоже можео делать лекарства.
...
* Увеличено колличество ХП боссам GC.
* Исправлена ошибка с броней GT, теперь она устанавливает и держит вашу температуру на 20 градусах.
* Колличество модификаторов тепла и холода, действующих на вас, увеличено с 3 -> 10
...
* Изменен крафт парашутов GC и их раскраску.
* Скрыт не используемый катализатор и лекарство TFCMedicinal.
* Изменен крафт шеста, блока телеметрии, клапана, спасательной коробки, подруливающего устройства, канистры из олова, жидкостной капсулы, антены для связи, концентратора, экрана просмотра, осветительной панели, балонов, добавлен рецепт всем вакумным стеклам, грузовому загрузчику/разгрузчику, GC.
* Исправлен рецепт молда GT для ножа.
* Добавлен рецепт резинового листа в машину GT.
* Доабвлены ордикты для парашутов GC.
* Добавлены ордикты для ящиков GT.
* Удалены дублирующие ордикты у материалов, не GT.
* Исправлен крафт вулканизирующего агента, тепрь он использует парашок графита.
* Исправле рецепт с преобразованием интерфейсов AE, в их плоские варианты.
