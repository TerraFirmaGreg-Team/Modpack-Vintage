...
## Version R4.1.9 - 22.12.2022

### Исправления модпака
- Новогоднее оформление (o^▽^o)
- Некоторые моды на оптимизацию удалены и были заменены на один, UniversalTweaks, в который встроенны те же исправления.
...
- Обновлен мод Darkness, раньше наблюдалосб падение фпс при взгляде на небо, это исравлено.
- Уменьшено колличесвто  мобов на игрока, это должно способствовть повышению производительности, если видите что мобов мало, сообщите, 140 -> 30, на игрока.
- Удален RealBench, в нем теперь нет необходимости, так как инжинерная станция была исправлена в обновлении GT.
...
- Удален рецепт разбора кирпича из огнеупорной глины, обратно в глину, таким образом исправл дюп.
...
- Исправлен убогий цвет соленой воды![изображение](https://media.discordapp.net/attachments/894603571423748156/898422502009765909/2021-10-15_10.09.04.png?width=987&height=519)
- Добавлен CarryOn.
- Добавлен Puddles.
...
- Обновлен Gregicality(Список изменений тут: [ссылка](https://www.curseforge.com/minecraft/mc-mods/gregicality/files/3449401 "нажми"))
