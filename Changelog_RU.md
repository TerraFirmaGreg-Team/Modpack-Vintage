...
- Удален VolumetricFlasks.
- Добавлен Fluid Crafting.
...
```
- Релиз 3.0.6 на Huge(не стабильна, сообщайте о багах) и Normal версиях.
...
```
- GTCE заменен на GTCEu, из-за того, что старая версия перестала обновляться по не понятным причинам, новая же версия содержит в себе миллионы исправлений и оптимизаций, все это вы можете посмотреть по ссылке:https://github.com/Gregicality/GregTech, в файле ChangeLog-GTCEU.
...
- Исправлен квест на бронзу(Huge версия).
```
