...
- Эндер сундуки, резервуары, сумки, теперь соеденены только в пределах одного измерения, но теперь имеют большую вместимость 3x9 -> 6x9.
...
- Колличество источников тепла действующих на игрока изменилось 4 -> 10
- Включен спавн папугаев.
...
- Список животных, из которых выпадает сычужный фермент теперь
  ...
  - muskox
  - yak
- Исправлен краш, при выходе с сервера при активном иследовании в телескопе.
...
- На небе теперь будет появлятся северное сияние.
...
- Чтоб заработать монет, вы темерь можете конвертировать не только монеты gregtech, но и так же дерево, командой /convert.
