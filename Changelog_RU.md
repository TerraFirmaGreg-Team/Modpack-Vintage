...
* Исправлены рецепты использующие Кованное железо и Обычное железо, теперь практически во всех рецептах верстака можно использовать и то и то железо, но не во всех, в логических соображениях. Также кованное железо нельзя использовать для крафта тех же предметов в GT машинах, так как кованное железо все же хуже ко качеству чем чистое (небольшая условност, которая прибавит вам производительности модпака :D).
