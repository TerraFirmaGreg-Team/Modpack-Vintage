...
#### [Normal, Huge]
### Исправления модпака
* В рецепте защищеных ламп ProjectRed, теперь используется сетка GC.
...
* Увеличен шанс выпадения саженца секвои 15 -> 35.
* Добавлены рецепты для ракет и ее омпонентов T4-T6.
