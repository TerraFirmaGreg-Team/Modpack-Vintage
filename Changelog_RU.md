...
#### [Normal, Huge]
### Исправления модпака
* Теперь примитивная помпа добывает свежут воду, а не соленую.
...
* Все предметы созданые ContentTweaker, были перенесены в TFG-mod.
...
* Телепорт на магилу теперь возможен только в радиусе 64 блока. Без использования жемчуга края.
...
* Изменены рецепты посадочных модулей, сверх-прочных пластин, частей ракет, в связи с переносом предметов из ContentTweaker в TFG-mod.
...
* Крафт ячеек, с использованием 4 компонентов предидущего тира, теперь стал в 2 раза быстрее, и использует 2 процессора, вместо 4.
...
* По умолчанию теперь иследована луна.
...
* Добавлены крафты для символьных кристалов Aunis.
* Добавлен крафт для портативного устройства древних Aunis.
* Доабвлен крафт для выращивания белого кристала Aunis.
* Добавлен крафт для теплостойкой подложки с 1-4 уровень.
* Добавлен/изменен крафт для теплостойкой ткани с 1-4 уровень.
* Удален дулирующий рецепт парашута.
* Удалены дулирующиt рецепты для погрузчиков и разгрузчиков GC.
### Обновление модов
