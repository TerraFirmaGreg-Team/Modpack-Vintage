...
## Version R3.4.1 - Ожидается 30.06.2022
#### [Lite, Huge]
### Исправления модпака
* Добавлен TFC-Ambiental (с исправлениями, например: система температуры TFC будет работать только на Земле, на остальных планетах, система температуры GC).
