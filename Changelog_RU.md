...
* И еще что-то, что мы забыли.[Huge]
...
* Исправлены рецепты ножей. Теперь из отливочного лезвия из TFC. Можно сделать адекватный нож из GT.[Huge]
...
* Исправлен баг в квестах с жидкостями, когда засчитывался квест без нужной жидкости.[Huge]
...
* Исправлены некоторые проблемы со словарями руд.[Huge]
