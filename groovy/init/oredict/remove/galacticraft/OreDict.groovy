...
ore('ingotCopper').remove([
  item('galacticraftcore:basic_item', 3)
])
ore('blockCopper').remove([
...
ore('blockSilicon').remove([
  item('galacticraftcore:basic_block_core', 13)
])

// Квартц
ore('oreQuartz').remove([
