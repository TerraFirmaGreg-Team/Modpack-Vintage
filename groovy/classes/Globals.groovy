...
mods.gregtech.assembler                 = recipemap('mods.gregtech.assembler')
...
circuit13 = metaitem('circuit.integrated').withNbt([Configuration: 13])
circuit14 = metaitem('circuit.integrated').withNbt([Configuration: 14])
circuit15 = metaitem('circuit.integrated').withNbt([Configuration: 15])
circuit16 = metaitem('circuit.integrated').withNbt([Configuration: 16])
circuit17 = metaitem('circuit.integrated').withNbt([Configuration: 17])
circuit18 = metaitem('circuit.integrated').withNbt([Configuration: 18])
circuit19 = metaitem('circuit.integrated').withNbt([Configuration: 19])
circuit20 = metaitem('circuit.integrated').withNbt([Configuration: 20])
circuit21 = metaitem('circuit.integrated').withNbt([Configuration: 21])
circuit22 = metaitem('circuit.integrated').withNbt([Configuration: 22])
