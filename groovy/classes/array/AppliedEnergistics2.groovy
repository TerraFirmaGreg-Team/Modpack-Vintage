class AppliedEnergistics2 {
  ...
  // Covered Cable
  static final List coveredCables = [
  ...
  // Dense Smart Cable
  static final List denseSmartCables = [
  ...
  // Dense Covered Cable
  static final List denseCoveredCables = [
  ...
  // Lumen paint ball
  static final List paintBallsLumen = [
  ...
  static final List storageComponents = [
  ...
  // - All ME Storage cell
  static final List storageCells = [
  ...
  static final List fluidStorageComponents = [
  ...
  static final List fluidStorageCells = [
  ...
  static final List craftingStorage = [
