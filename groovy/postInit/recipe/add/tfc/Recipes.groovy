...
//for (int i = 0; i < Minecraft.stainedHardenedClay.size(); i++) {
//  mods.gregtech.chemical_bath.recipeBuilder()
//    .inputs(item('minecraft:hardened_clay'))
//    .fluidInputs(Minecraft.colorLiquid[i] * 18)
//    .outputs(Minecraft.stainedHardenedClay[i])
//    .duration(400).EUt(3).buildAndRegister()
//}

// All Colored Terracotta
for (i in Minecraft.stainedHardenedClay) {
  mods.gregtech.macerator.recipeBuilder()
    .inputs(i)
    .outputs(metaitem('dustClay') * 4)
    .duration(15).EUt(3).buildAndRegister()
...
for (int i = 0; i < TerraFirmaCraft.smallClayUnfiredColoredVessels.size(); i++) {
  mods.gregtech.chemical_bath.recipeBuilder()
    .inputs(item('tfc:ceramics/unfired/vessel'))
    .fluidInputs(Minecraft.colorLiquid[15 - i] * 18)
    .outputs(TerraFirmaCraft.smallClayUnfiredColoredVessels[i])
    .duration(400).EUt(3).buildAndRegister()

  mods.gregtech.macerator.recipeBuilder()
    .inputs(TerraFirmaCraft.smallClayUnfiredColoredVessels[i])
    .outputs(metaitem('dustClay') * 3)
    .duration(15).EUt(3).buildAndRegister()

  mods.gregtech.electric_furnace.recipeBuilder()
    .inputs(TerraFirmaCraft.smallClayUnfiredColoredVessels[i])
    .outputs(TerraFirmaCraft.smallClayFiredColoredVessels[i])
    .duration(100).EUt(3).buildAndRegister()
}


// Clay Made Items
for (int i = 0; i < TerraFirmaCraft.clayMadeFiredItems.size(); i++) {
//     mods.gregtech.assembler.recipeBuilder()
//             .inputs(item('minecraft:clay_ball') * 3)
//             .circuitMeta(i + 1)
//             .outputs(TerraFirmaCraft.clayMadeUnfiredItems[i])
//             .duration(200).EUt(3).buildAndRegister()

  mods.gregtech.macerator.recipeBuilder()
    .inputs(TerraFirmaCraft.clayMadeUnfiredItems[i])
    .outputs(metaitem('dustClay') * 3)
    .duration(15).EUt(3).buildAndRegister()

  mods.gregtech.electric_furnace.recipeBuilder()
    .inputs(TerraFirmaCraft.clayMadeUnfiredItems[i])
    .outputs(TerraFirmaCraft.clayMadeFiredItems[i])
    .duration(100).EUt(3).buildAndRegister()
}
...
for (int i = 0; i < TerraFirmaCraftF.mudBricksItem.size(); i++) {
  mods.gregtech.assembler.recipeBuilder()
    .circuitMeta(4)
    .inputs(TerraFirmaCraftF.mudBricksItem[i] * 4)
    .fluidInputs(fluid('concrete') * 100)
    .outputs(TerraFirmaCraftF.mudBricksBlock[i] * 4)
    .duration(200).EUt(7).buildAndRegister()
}
...
mods.gregtech.assembler.recipeBuilder()
  .inputs(
    ...
    ore('dyeRed'))
  .circuitMeta(16)
  .outputs(item('tfg:device/powderkeg'))
  .duration(150).EUt(2).buildAndRegister()
