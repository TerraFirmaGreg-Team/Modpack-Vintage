...
// IC Chip
mods.minecraft.crafting.addShaped("projectred/ic_chip", item('projectred-fabrication:ic_chip'),
...
// IC Printer
mods.minecraft.crafting.addShaped("projectred/ic_machine_1", item('projectred-fabrication:ic_machine:1'),
