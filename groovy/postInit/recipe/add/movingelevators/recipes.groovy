...
// Elevator Controller
mods.minecraft.crafting.addShaped("movingelevators/elevator_block", item('movingelevators:elevator_block'),
...
// Elevator Screen
mods.minecraft.crafting.addShaped("movingelevators/display_block", item('movingelevators:display_block'),
...
mods.minecraft.crafting.addShaped("movingelevators/button_block", item('movingelevators:button_block'),
