...
// Рюкзак
mods.minecraft.crafting.addShaped("travelersbackpacks/travelers_backpack", item('travelersbackpack:travelers_backpack'), [
...
// Носик
mods.minecraft.crafting.addShaped("travelersbackpacks/hose_nozzle", item('travelersbackpack:hose_nozzle'), [
  [metaitem('ringGold'), item('minecraft:lever'), null]])

// Шланг
mods.minecraft.crafting.addShaped("travelersbackpacks/hose", item('travelersbackpack:hose'), [
