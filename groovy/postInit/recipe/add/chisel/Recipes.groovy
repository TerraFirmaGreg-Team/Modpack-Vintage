...
// Авто Стамеска
mods.minecraft.crafting.addShaped("chisel/auto_chisel", item('chisel:auto_chisel'), [
...
mods.minecraft.crafting.addShaped("chisel/offsettool", item('chisel:offsettool'), [
...
// Железная стамеска
mods.minecraft.crafting.addShaped("chisel/chisel_iron", item('chisel:chisel_iron'), [
...
// Алмазная стамеска
mods.minecraft.crafting.addShaped("chisel/chisel_diamond", item('chisel:chisel_diamond'), [
...
mods.minecraft.crafting.addShaped("chisel/chisel_hitech", item('chisel:chisel_hitech'), [
        [ore('toolFile').transform(Function.setToolDamage), metaitem('plateDiamond'), metaitem('plateDiamond')],
...
// Лабораторный блок
mods.minecraft.crafting.addShaped("chisel/laboratory_block", item('chisel:laboratory') * 8, [
        [ore('stone'), ore('stone'), ore('stone')],
        [ore('stone'), item('minecraft:quartz'), ore('stone')],
        [ore('stone'), ore('stone'), ore('stone')]])

// Храмовый блок
mods.minecraft.crafting.addShaped("chisel/temple_block", item('chisel:temple') * 8, [
        [ore('stone'), ore('stone'), ore('stone')],
        [ore('stone'), ore('dyeCyan'), ore('stone')],
        [ore('stone'), ore('stone'), ore('stone')]])

// Тириан блок
mods.minecraft.crafting.addShaped("chisel/tyrian_block", item('chisel:tyrian') * 8, [
        [ore('stone'), ore('stone'), ore('stone')],
        [ore('stone'), ore('plateIronAny'), ore('stone')],
        [ore('stone'), ore('stone'), ore('stone')]])

// Заводской блок
mods.minecraft.crafting.addShaped("chisel/factory_block", item('chisel:factory') * 8, [
        [ore('plateIronAny'), ore('stone'), ore('plateIronAny')],
        [ore('stone'), null, ore('stone')],
        [ore('plateIronAny'), ore('stone'), ore('plateIronAny')]])

// Коричневый камень
mods.minecraft.crafting.addShaped("chisel/brownstone", item('chisel:brownstone') * 8, [
