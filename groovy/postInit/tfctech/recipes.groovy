...
crafting.addShapeless("tfctech/pot_ash", item('tfctech:pot_ash'), [metaitem('dustAsh'), metaitem('dustAsh'), metaitem('dustAsh'), metaitem('dustAsh'), item('tfc:ceramics/fired/pot').noreturn(), item('tfc:wooden_bucket').withNbt(["Fluid": ["FluidName": "fresh_water", "Amount": 1000]])])
